...
export const ALL_REVENUE_REQUEST = "ALL_REVENUE_REQUEST";
export const ALL_REVENUE_SUCCESS = "ALL_REVENUE_SUCCESS";
export const ALL_REVENUE_FAIL = "ALL_REVENUE_FAIL";
