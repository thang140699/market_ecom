(window.Modernizr = (function (a, b, c) {
  ...
  function k() {
    (m.input = (function (c) {
      ...
      (m.inputtypes = (function (a) {
        for (var e, f, g, d = 0, h = a.length; d < h; d++)
          s.setAttribute("type", (f = a[d])),
            (e = "text" !== s.type),
            e &&
              ((s.value = t),
              (s.style.cssText = "position:absolute;visibility:hidden;"),
              /^range$/.test(f) && s.style.WebkitAppearance !== c
                ? (o.appendChild(s),
                  (g = b.defaultView),
                  (e =
                    g.getComputedStyle &&
                    "textfield" !==
                      g.getComputedStyle(s, null).WebkitAppearance &&
                    0 !== s.offsetHeight),
                  o.removeChild(s))
                : /^(search|tel)$/.test(f) ||
                  (e = /^(url|email)$/.test(f)
  ...
  var F,
    ...
    z = { svg: "https://www.w3.org/2000/svg" },
    A = {},
    B = {},
    C = {},
    D = [],
    ...
    J = {}.hasOwnProperty;
  (K =
    f(J, "undefined") || f(J.call, "undefined")
      ? function (a, b) {
    ...
    (A.rgba = function () {
      return (
        d("background-color:rgba(150,255,150,.5)"), g(r.backgroundColor, "rgba")
      );
    }),
    (A.hsla = function () {
      return (
    ...
    (A.cssgradients = function () {
      ...
      return (
        d(
          (a + "-webkit- ".split(" ").join(b + a) + v.join(c + a)).slice(
            0,
            -a.length
          )
        ),
    ...
    (A.smil = function () {
      return (
        !!b.createElementNS &&
        /SVGAnimate/.test(u.call(b.createElementNS(z.svg, "animate")))
      );
    }),
    (A.svgclippaths = function () {
      return (
        !!b.createElementNS &&
        /SVGClipPath/.test(u.call(b.createElementNS(z.svg, "clipPath")))
      );
    });
  for (var L in A)
    K(A, L) &&
      ((F = L.toLowerCase()), (m[F] = A[L]()), D.push((m[F] ? "" : "no-") + F));
  return (
    m.input || k(),
    (m.addTest = function (a, b) {
      if ("object" == typeof a) for (var d in a) K(a, d) && m.addTest(d, a[d]);
      else {
      ...
      function f(a, c, d) {
        ...
        return (
          (f = d.cache[a]
            ...
            : d.createElem(a)),
          !f.canHaveChildren || l.test(a) || f.tagUrn
            ? f
